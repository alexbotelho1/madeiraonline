...
<table border="0" cellpadding="0" cellspacing="0" width="118" height="61">
	<tr>
		<td width="118" height="22" background="images/text6.gif" valign="top" style="padding-top:5;padding-left:30; border-right-width:1; border-top-width:1; border-bottom-width:1"><font class=bold>5 mais lidas</font></td>
	</tr>
	<tr>
    	<td width="118" height="39" align="center" valign="top"><!--#include file="manchetes_right.asp" --></td>
    </tr>
</table>
